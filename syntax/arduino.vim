" Vim syntax file
" Language:    Arduino
" Maintainer:  Adrian <Adrian@aztli.org>
" Original Author:  Johannes Hoff <johannes@johanneshoff.com>
" Last Change: 11 Octubre 2016
...
" The support for the arduino 1.6.12
"
...
"/Program Files (x86)/Arduino\hardware\arduino\avr\libraries\EEPROM\keywords.txt{{{
	syn keyword arduinoClass EEPROM
	syn keyword arduinoFunc read write update get put
"}}}


"/Program Files (x86)/Arduino\hardware\arduino\avr\libraries\SoftwareSerial\keywords.txt{{{
...
"}}}
"/Program Files (x86)/Arduino\libraries\Ethernet\keywords.txt{{{
	syn keyword arduinoClass Ethernet EthernetClient EthernetServer IPAddress
	syn keyword arduinoFunc status connect write available read peek
...
"C:/Program Files (x86)/Arduino\libraries\Firmata\keywords.txt{{{
	...
	syn keyword arduinoFunc callbackFunction systemResetCallbackFunction stringCallbackFunction sysexCallbackFunction begin begin printVersion blinkVersion printFirmwareVersion
	...
	syn keyword arduinoClass Firmata
"}}}
"C:/Program Files (x86)/Arduino\libraries\GSM\keywords.txt{{{
	syn keyword arduinoConstant GSMPIN GSMPIN ERROR IDLE CONNECTING GSM_READY GPRS_READY
	syn keyword arduinoClass GSM GSMVOICECALL GSM_SMS GPRS GSMServer GSMClient
	...
	syn keyword arduinoFunc GSMVoiceCall GSMModem GSMScanner begin shutdown gatVoiceCallStatus ready voiceCall
...
hi def link arduinoClass Macro
