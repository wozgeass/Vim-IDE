...
syn keyword junosKeyword    alg log login node zone path community bridge
...
syn keyword junosProtocol   ospf ospf3 rip ripng isis spanning-tree 
syn keyword junosProtocol   igmp igmp-snooping lldp lldp-med mld mld-snooping msdp mstp mvrp mpls vpls vrrp lacp
syn keyword junosProtocol   stp sflow vstp dot1x msrp msrpc sunrpc icmp ping pim rstp rsvp netconf vlag
